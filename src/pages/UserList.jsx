...
import { UserPlus, Search, Filter, Eye, Edit, Trash2, ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight } from 'lucide-react';
...
const UserList = () => {
  ...
  const fetchUsers = useCallback(async () => {
    ...
    try {
      ...
      if (searchTerm.trim()) {
        // Attempt search with original term
        response = await userService.search(searchTerm.trim(), limit, skip);
        
        // DummyJSON is case-sensitive. If "jon" returns 0, retry with "Jon"
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        <div className="md:col-span-3 relative">
          ...
          <input
            ...
            className="w-full border-2 border-gray-100 bg-white p-3 pl-12 rounded-xl focus:ring-4 focus:ring-blue-50 focus:border-blue-400 outline-none transition text-gray-900"
            value={searchTerm}
        ...
        <div className="relative">
          ...
          <select 
            className="w-full border-2 border-gray-100 p-3 pl-10 rounded-xl bg-white focus:ring-4 focus:ring-blue-50 focus:border-blue-400 outline-none text-gray-900 appearance-none cursor-pointer"
            value={roleFilter}
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-gray-50">
                {users.length > 0 ? users.map((user) => (
                  ...
                  <tr><td colSpan="4" className="p-12 text-center text-gray-400 font-medium">No results found.</td></tr>
                )}
              </tbody>
            </table>
          </div>
      ...
      <div className="mt-8 flex items-center justify-center gap-4">
        <div className="flex items-center gap-1">
          <button 
            ...
            className="p-2 border rounded-xl text-black hover:bg-white disabled:opacity-20 shadow-sm transition"
          >
